...
def analyze(test_db, test_index):
    ...
    # Else list out available tests to choose from
        ...
        # Number of tests is the length of the list inside the database list at the chosen index location
        num_tests = len(test_db[test_choice]) 
        # Maximum score is the maximum score value added from when the structure was created and added to the index
        max_s = test_index[test_choice]['maxscore'] 
        # The list of tests is all tests in the list inside the database list at the chosen index location
